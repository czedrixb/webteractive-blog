            ...
            <div class="flex flex-col gap-3">
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div wire:ignore>
                        ...
                        <img src="{{ asset('uploads/' . $image) }}" class="max-w-[50%]" alt="">
                    </div>
                </div>
                ...
                <div class="flex justify-end">
                    <div class="flex gap-1 items-center">
                        <a wire:navigate href="{{ route('blogs.index') }}"
                            class="bg-zinc-500 hover:bg-zinc-700 uppercase flex items-center gap-2 font-semibold  text-white text-sm py-2.5 px-5 transition duration-300">
                            back
                        </a>
                        <button type="submit"
                            class="bg-green-600 hover:bg-green-700 uppercase flex items-center gap-2 font-semibold  text-white text-sm py-2.5 px-5 transition duration-300">
                            submit
                        </button>
                    </div>
                </div>
